...
def show_results(response_testing, predictions):
    print("\nPredicted Values:")
    print(predictions)
...
def perform_logistic_regression(predictors_df, response_series):
    ...
    show_results(response_testing, predictions)
...
def main():
    ...
    # I was unable to get the import working for imblearn, but here is the code I would have used to balance the dataset:
    # Intended balancing step for the assignment:
    #
    # from imblearn.over_sampling import RandomOverSampler
    # random_over_sampler = RandomOverSampler(random_state=1)
    # balanced_predictors, balanced_response = random_over_sampler.fit_resample(
    #     predictors_df,
    #     response_series
    # )
    #
    # perform_logistic_regression(balanced_predictors, balanced_response)
